...
let blueC = ['#3289E9', '#5D9DE2', '#85BDF6', '#ACC4E5', '#D2E2F7', '#E4ECF7'];
let pinkC = [
  '#A85CD3',
  '#BF78DC',
  '#D5B9F5',
...
const initBunch = (width, height) => {
  ...
  bgColor = blueC[Math.floor(random.range(0, blueC.length))];
...
const initFlower = (width, height) => {
  ...
  for (let i = 0; i < numColors; i++) {
    ...
    //rectColors[i] = pinkC[Math.floor(random.range(0, blueC.length))];
  }
